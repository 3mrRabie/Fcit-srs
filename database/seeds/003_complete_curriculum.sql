...
BEGIN
    ...
    IF v_fall2025_id IS NOT NULL THEN
        INSERT INTO course_offerings (semester_id, course_id, doctor_id, capacity) VALUES
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS111'), v_doctor_id, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS112'), v_doctor_id, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='BS111'), NULL, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='BS112'), NULL, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='BS115'), NULL, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='IS111'), NULL, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='IT111'), NULL, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='UNV111'), NULL, 120),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='UNV112'), NULL, 120),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='UNV113'), NULL, 120),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='UNV114'), NULL, 120),
        -- Level 2 offerings
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS211'), v_doctor_id, 55),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS212'), v_doctor_id, 55),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS213'), v_doctor_id, 55),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS214'), v_doctor_id, 55),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='BS113'), NULL, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='BS114'), NULL, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='BS116'), NULL, 60),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='IS211'), v_doctor_id, 55),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='IT211'), v_doctor_id, 55),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='SE211'), v_doctor_id, 55),
        -- Level 3 CS offerings
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS311'), v_doctor_id, 50),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS312'), v_doctor_id, 50),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS313'), v_doctor_id, 50),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS314'), v_doctor_id, 50),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS315'), v_doctor_id, 50),
        (v_fall2025_id, (SELECT id FROM courses WHERE code='CS316'), v_doctor_id, 50);
    END IF;

    -- SPRING 2026 offerings
    IF v_spring2026_id IS NOT NULL THEN
        INSERT INTO course_offerings (semester_id, course_id, doctor_id, capacity) VALUES
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS111'), v_doctor_id, 60),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS112'), v_doctor_id, 60),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='BS111'), NULL, 60),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='BS113'), NULL, 60),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='BS116'), NULL, 60),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='IS111'), NULL, 60),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='IT111'), NULL, 60),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='UNV111'), NULL, 120),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='UNV113'), NULL, 120),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS211'), v_doctor_id, 55),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS212'), v_doctor_id, 55),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS213'), v_doctor_id, 55),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='BS114'), NULL, 60),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='BS117'), NULL, 60),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='IS211'), v_doctor_id, 55),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='IS212'), v_doctor_id, 55),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='IT211'), v_doctor_id, 55),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='SE211'), v_doctor_id, 55),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS311'), v_doctor_id, 50),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS313'), v_doctor_id, 50),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS411'), v_doctor_id, 45),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS412'), v_doctor_id, 45),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS414'), v_doctor_id, 45),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='CS415'), v_doctor_id, 45),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='PR411'), v_doctor_id, 30),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='IS311'), v_doctor_id, 50),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='IS312'), v_doctor_id, 50),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='SE311'), v_doctor_id, 50),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='SE313'), v_doctor_id, 50),
        (v_spring2026_id, (SELECT id FROM courses WHERE code='IT311'), v_doctor_id, 50);
    END IF;
