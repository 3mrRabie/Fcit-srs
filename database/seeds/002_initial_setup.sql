...
BEGIN
    ...
    ('CS', 'Ù‚Ø³Ù… Ø¹Ù„ÙˆÙ… Ø§Ù„Ø­Ø§Ø³Ø¨',       'Computer Science'),
    ('IS', 'Ù‚Ø³Ù… Ù†Ø¸Ù… Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª',     'Information Systems'),
    ('IT', 'Ù‚Ø³Ù… ØªÙƒÙ†ÙˆÙ„ÙˆØ¬ÙŠØ§ Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª', 'Information Technology'),
    ('SE', 'Ù‚Ø³Ù… Ù‡Ù†Ø¯Ø³Ø© Ø§Ù„Ø¨Ø±Ù…Ø¬ÙŠØ§Øª',   'Software Engineering');
    ...
    VALUES (
        (SELECT id FROM academic_years WHERE year_label = '2024-2025'),
        'second', 'الترم الثاني 2025', 'closed',
    ...
    VALUES (
        (SELECT id FROM academic_years WHERE year_label = '2025-2026'),
        'second', 'الترم الثاني 2026', 'upcoming',
    ...
    VALUES (
        (SELECT id FROM academic_years WHERE year_label = '2025-2026'),
        'summer', 'الترم الصيفي 2026', 'upcoming',
    ...
    ('TOTAL_CREDITS',     'Graduation', 'Total Required Credit Hours', 'Students must pass 138 credit hours', 'Art.4', 138),
    ...
    ('SUMMER_MAX_CREDITS','Registration','الترم الصيفي Max Credits', 'Maximum 7 credit hours in summer semester', 'Art.11', 7),
    ('FRESHMAN_MAX',      'Registration','Freshman Semester Max Credits', 'Maximum 27 credit hours for freshmen', 'Art.11', 27),
    ('NEW_STUDENT_MAX',   'Registration','New Student الترم الأول Max', 'Maximum 20 credit hours for new students', 'Art.11', 20),
