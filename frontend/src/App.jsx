...
// Wrapper to retry lazy loading on ChunkLoadError
        ...
        <AuthProvider>
          <BylawProvider>
            <Toaster
              position="top-center"
              toastOptions={{
                duration: 1500, // Reduced duration for cleaner UX
                style: { fontFamily: 'var(--font-family)', direction: 'rtl', fontSize: '14px', borderRadius: 'var(--radius-lg)', border: '1px solid var(--color-gray-200)', background: 'var(--color-white)', color: 'var(--color-gray-800)' },
